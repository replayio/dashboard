...
export type GetWorkspaceApiKeysQuery = { __typename?: 'query_root', node?: { __typename?: 'Recording' } | { __typename?: 'RootCauseAnalysis' } | { __typename?: 'Workspace', apiKeys?: Array<{ __typename?: 'WorkspaceAPIKey', id: string, createdAt: any, label: string, scopes: Array<string>, recordingCount: number, maxRecordings?: number | null }> | null } | null };
...
export type GetDefaultWorkspaceQuery = { __typename?: 'query_root', viewer?: { __typename?: 'AuthenticatedUser', defaultWorkspace?: { __typename?: 'Workspace', id: string } | null } | null };

export type GetNonPendingWorkspacesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetNonPendingWorkspacesQuery = { __typename?: 'query_root', viewer?: { __typename?: 'AuthenticatedUser', workspaces: { __typename?: 'UserWorkspaceConnection', edges: Array<{ __typename?: 'UserWorkspaceEdge', node: { __typename?: 'Workspace', id: string, invitationCode?: string | null, isTest: boolean, name: string } }> } } | null };
...
export type UpdateDefaultWorkspaceMutationVariables = Exact<{
  workspaceId?: InputMaybe<Scalars['ID']['input']>;
}>;


export type UpdateDefaultWorkspaceMutation = { __typename?: 'mutation_root', updateUserDefaultWorkspace: { __typename?: 'UpdateUserDefaultWorkspace', success?: boolean | null, workspace?: { __typename?: 'Workspace', id: string } | null } };
...
export const UpdateDefaultWorkspaceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateDefaultWorkspace"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"workspaceId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateUserDefaultWorkspace"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"workspaceId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"workspaceId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"success"}},{"kind":"Field","name":{"kind":"Name","value":"workspace"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]} as unknown as DocumentNode<UpdateDefaultWorkspaceMutation, UpdateDefaultWorkspaceMutationVariables>;